...
var he2 = o2(({ action: e2, resource: t, onMutationSuccess: r, onMutationError: s, autoSave: n2, submitOnEnter: i = false, warnWhenUnsavedChanges: a, redirect: p, successNotification: l, errorNotification: m, meta: u, metaData: d, queryMeta: c, mutationMeta: f, liveMode: h, liveParams: y, mutationMode: g, dataProviderName: b, onLiveEvent: P, invalidates: B, undoableTimeout: C, queryOptions: S, createMutationOptions: k, updateMutationOptions: F, id: D, overtimeOptions: T, optimisticUpdateMap: v, defaultFormValues: U, disableServerSideValidation: H = false } = {}) => {
  var _, fe;
  let { options: j } = ge(), x = (j == null ? void 0 : j.disableServerSideValidation) || H, K = $(), [$2] = form_default.useForm(), A2 = useForm({ form: $2, defaultFormValues: U }), { form: E } = A2, q = xh({ onMutationSuccess: r || void 0, onMutationError: async (Z, ee, le2) => {
    if (x) {
      s == null || s(Z, ee, le2);
      return;
    }
  ...
  }, redirect: p, action: e2, resource: t, successNotification: l, errorNotification: m, meta: A(u, d), metaData: A(u, d), queryMeta: c, mutationMeta: f, liveMode: h, liveParams: y, mutationMode: g, dataProviderName: b, onLiveEvent: P, invalidates: B, undoableTimeout: C, queryOptions: S, createMutationOptions: k, updateMutationOptions: F, id: D, overtimeOptions: T, optimisticUpdateMap: v, autoSave: n2 }), { formLoading: L, onFinish: O, query: M, id: Y2, onFinishAutoSave: N } = q, { warnWhenUnsavedChanges: z, setWarnWhen: w } = vt(), R = a ?? z;
  ...
  return { form: A2.form, formProps: { ...A2.formProps, onFinish: (Z) => O(Z).catch((ee) => ee), onKeyUp: J, onValuesChange: X, initialValues: (fe = M == null ? void 0 : M.data) == null ? void 0 : fe.data }, saveButtonProps: se2, defaultFormValuesLoading: A2.defaultFormValuesLoading, ...q, onFinish: async (Z) => await O(Z ?? A2.form.getFieldsValue(true)) };
}, "useForm");
...
var ro = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  var z, w;
  let [p, l] = import_react77.default.useState(false), m = Ae(), { resource: u, action: d, identifier: c } = Y(a.resource), f = Te(), h = he(), y = Pt(), g = a.action ?? d ?? "", b = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), P = typeof e2 == "object" && "key" in e2 ? e2.key : u && g && e2 ? `modal-${c}-${g}` : void 0, B = he2({ meta: { ...P ? { [P]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: C, formProps: S, id: k, setId: F, formLoading: D, onFinish: T, autoSaveProps: v } = B, U = $(), { warnWhen: H, setWarnWhen: j } = vt(), { show: x, close: K, modalProps: $2 } = to2({ modalProps: { open: t } }), A2 = $2.open || false, E = { modalProps: $2, form: C, formLoading: D, formProps: S, formResult: void 0, formValues: C.getFieldsValue, defaultFormValuesLoading: false, initialValues: {}, submit: T, close: K, open: $2.open || false, show: x, visible: A2 };
  import_react77.default.useEffect(() => {
    ...
    if (p === false && P) {
      ...
      if (typeof _ == "boolean" ? _ && x() : typeof _ == "string" && _ === "true" && x(), b) {
        let fe = (se2 = (X = f == null ? void 0 : f.params) == null ? void 0 : X[P]) == null ? void 0 : se2.id;
        fe && (F == null || F(fe));
      }
      l(true);
    }
    ...
    var R;
    p === true && (A2 && P ? h({ query: { [P]: { ...(R = f == null ? void 0 : f.params) == null ? void 0 : R[P], open: true, ...b && k && { id: k } } }, options: { keepQuery: true }, type: "replace" }) : P && !A2 && h({ query: { [P]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [k, A2, x, P, b]);
  ...
  return { ...B, ...E, show: O, close: L, open: A2, formProps: { ...S, ...B.formProps, onValuesChange: S == null ? void 0 : S.onValuesChange, onKeyUp: S == null ? void 0 : S.onKeyUp, onFinish: async (R) => {
...
var no2 = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  let p = Ae(), [l, m] = import_react78.default.useState(false), { visible: u, show: d, close: c } = fR({ defaultVisible: t }), { resource: f, action: h, identifier: y } = Y(a.resource), g = Te(), b = he(), P = a.action ?? h ?? "", B = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), C = typeof e2 == "object" && "key" in e2 ? e2.key : f && P && e2 ? `drawer-${(f == null ? void 0 : f.identifier) ?? (f == null ? void 0 : f.name)}-${P}` : void 0, S = he2({ meta: { ...C ? { [C]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: k, formProps: F, formLoading: D, id: T, setId: v, onFinish: U, autoSaveProps: H } = S;
  import_react78.default.useEffect(() => {
    ...
    if (l === false && C) {
      ...
      if (typeof N == "boolean" ? N ? d() : c() : typeof N == "string" && N === "true" && d(), B) {
        let z = (Y2 = (M = g == null ? void 0 : g.params) == null ? void 0 : M[C]) == null ? void 0 : Y2.id;
        z && (v == null || v(z));
      }
      m(true);
    }
  ...
  let j = $(), { warnWhen: x, setWarnWhen: K } = vt(), $2 = { disabled: D, onClick: () => {
    k.submit();
  }, loading: D }, A2 = { recordItemId: T, onSuccess: () => {
    v == null || v(void 0), c();
    ...
    c(), v == null || v(void 0);
  }, [x]), q = (0, import_react78.useCallback)((L) => {
  ...
  } }, drawerProps: { width: "500px", onClose: E, open: u, forceRender: true }, saveButtonProps: $2, deleteButtonProps: A2, formLoading: D };
}, "useDrawerForm");
var ao = o2((e2 = {}) => {
...
var gt = o2(({ onSearch: e2, initialCurrent: t, initialPageSize: r, hasPagination: s = true, pagination: n2, initialSorter: i, permanentSorter: a, initialFilter: p, permanentFilter: l, defaultSetFilterBehavior: m, filters: u, sorters: d, syncWithLocation: c, resource: f, successNotification: h, errorNotification: y, queryOptions: g, liveMode: b, onLiveEvent: P, liveParams: B, meta: C, metaData: S, dataProviderName: k } = {}) => {
  let { tableQueryResult: F, tableQuery: D, current: T, setCurrent: v, pageSize: U, setPageSize: H, filters: j, setFilters: x, sorters: K, setSorters: $2, sorter: A2, setSorter: E, createLinkForSyncWithLocation: q, pageCount: L, overtime: O } = MC({ permanentSorter: a, permanentFilter: l, initialCurrent: t, initialPageSize: r, pagination: n2, hasPagination: s, filters: u, sorters: d, initialSorter: i, initialFilter: p, syncWithLocation: c, resource: f, defaultSetFilterBehavior: m, successNotification: h, errorNotification: y, queryOptions: g, liveMode: b, onLiveEvent: P, liveParams: B, meta: A(C, S), metaData: A(C, S), dataProviderName: k }), { syncWithLocation: M } = to(), Y2 = c ?? M, N = grid_default.useBreakpoint(), [z] = form_default.useForm(), w = useForm({ form: z }), R = on(b), J = s === false ? "off" : "server", X = ((n2 == null ? void 0 : n2.mode) ?? J) !== "off", se2 = A(u == null ? void 0 : u.initial, p), { data: _, isFetched: fe, isLoading: Z } = F;
  ...
  let ee = o2((de, te, me) => {
    ...
    var ne;
    let ce = q({ pagination: { pageSize: U, current: de }, sorters: K, filters: j });
  ...
  return { searchFormProps: { ...w.formProps, onFinish: le2 }, tableProps: { dataSource: _ == null ? void 0 : _.data, loading: R === "auto" ? Z : !fe, onChange: ee, pagination: ie2(), scroll: { x: true } }, tableQueryResult: F, tableQuery: D, sorters: K, sorter: A2, filters: j, setSorters: $2, setSorter: E, setFilters: x, current: T, setCurrent: v, pageSize: U, setPageSize: H, pageCount: L, createLinkForSyncWithLocation: q, overtime: O };
}, "useTable");
...
var mm = o2(({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: l, liveMode: m, defaultValue: u, selectedOptionsOrder: d, onLiveEvent: c, liveParams: f, meta: h, metaData: y, dataProviderName: g }) => {
  let { query: b, options: P } = TC({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: l, liveMode: m, defaultValue: u, selectedOptionsOrder: d, onLiveEvent: c, liveParams: f, meta: A(h, y), metaData: A(h, y), dataProviderName: g });
...
var Cm = o2(({ resource: e2, resourceName: t, mapData: r = o2((u) => u, "mapData"), paparseOptions: s, batchSize: n2 = Number.MAX_SAFE_INTEGER, onFinish: i, meta: a, metaData: p, dataProviderName: l, onProgress: m } = {}) => {
  let u = $(), { resource: d } = Y(e2 ?? t), { mutationResult: c, isLoading: f, handleChange: h } = pR({ resource: (d == null ? void 0 : d.identifier) ?? (d == null ? void 0 : d.name), mapData: r, paparseOptions: s, batchSize: n2, meta: A(a, p), metaData: A(a, p), dataProviderName: l, onFinish: i, onProgress: m ?? (({ totalAmount: y, processedAmount: g }) => {
    if (y > 0 && g > 0) {
...
var ns = o2(({ resource: e2, initialCurrent: t, initialPageSize: r, pagination: s, hasPagination: n2 = true, initialSorter: i, permanentSorter: a, initialFilter: p, permanentFilter: l, defaultSetFilterBehavior: m, filters: u, sorters: d, onSearch: c, queryOptions: f, syncWithLocation: h, successNotification: y, errorNotification: g, liveMode: b, onLiveEvent: P, liveParams: B, meta: C, metaData: S, dataProviderName: k } = {}) => {
  let { sorters: F, sorter: D, filters: T, current: v, pageSize: U, pageCount: H, setFilters: j, setCurrent: x, setPageSize: K, setSorter: $2, setSorters: A2, createLinkForSyncWithLocation: E, tableQueryResult: q, tableQuery: L, overtime: O } = MC({ resource: e2, initialSorter: i, permanentSorter: a, initialFilter: p, permanentFilter: l, filters: u, sorters: d, defaultSetFilterBehavior: m, initialCurrent: t, initialPageSize: r, queryOptions: f, successNotification: y, errorNotification: g, liveMode: b, onLiveEvent: P, liveParams: B, meta: A(C, S), metaData: A(C, S), syncWithLocation: h, dataProviderName: k, pagination: s, hasPagination: n2 }), M = n2 === false ? "off" : "server", Y2 = ((s == null ? void 0 : s.mode) ?? M) !== "off", N = grid_default.useBreakpoint(), z = on(b), [w] = form_default.useForm(), { data: R, isFetched: J, isLoading: X } = q, se2 = o2((Z, ee) => {
    Y2 && (x(Z), K(ee || 10));
  }, "onChange"), _ = o2(async (Z) => {
    if (c) {
      let ee = await c(Z);
      return Y2 && (x == null || x(1)), j(ee);
    }
    ...
    if (ee === "next" || ee === "prev") return (0, import_react82.createElement)(Fe, { to: ie2, element: le2 });
    ...
    return le2;
  }, pageSize: U, current: v, simple: !N.sm, total: R == null ? void 0 : R.total, onChange: se2 } : false, "antdPagination");
  return { searchFormProps: { form: w, onFinish: _ }, listProps: { dataSource: R == null ? void 0 : R.data, loading: z === "auto" ? X : !J, pagination: fe() }, query: L, queryResult: q, filters: T, setFilters: j, sorter: D, setSorter: $2, sorters: F, setSorters: A2, current: v, setCurrent: x, pageSize: U, setPageSize: K, pageCount: H, createLinkForSyncWithLocation: E, overtime: O };
}, "useSimpleList");
var Um = o2(() => {
...
var ac = { open: ({ key: e2, message: t, description: r, type: s, cancelMutation: n2, undoableTimeout: i }) => {
  s === "progress" ? notification_default.open({ key: e2, description: import_react87.default.createElement(ht, { notificationKey: e2, message: t, cancelMutation: () => {
...
var ic = o2(() => {
  ...
  return { open: ({ key: s, message: n2, description: i, type: a, cancelMutation: p, undoableTimeout: l }) => {
    a === "progress" ? t.open({ key: s, description: import_react87.default.createElement(ht, { notificationKey: s, message: n2, cancelMutation: () => {
...
var Ct = o2(({ Title: e2, render: t, meta: r }) => {
  let [s, n2] = (0, import_react90.useState)(false), [i, a] = (0, import_react90.useState)(false), p = yo(), l = se(), m = yt(), { warnWhen: u, setWarnWhen: d } = vt(), { Link: c } = le(), f = l === "legacy" ? c : m, h = Ta(), y = $(), { menuItems: g, selectedKey: b, defaultOpenKeys: P } = $u({ meta: r }), B = grid_default.useBreakpoint(), { hasDashboard: C } = ge(), S = ie(), { mutate: k } = Mr({ v3LegacyAuthProviderCompatible: !!(S != null && S.isLegacy) }), F = typeof B.lg > "u" ? false : !B.lg, D = e2 ?? h ?? Ft, T = o2((E, q) => E.map((L) => {
    let { icon: O, label: M, route: Y2, key: N, name: z, children: w, parentName: R, meta: J, options: X } = L;
    if (w.length > 0) return import_react90.default.createElement(wc, { key: L.key, resource: z, action: "list", params: { resource: L } }, import_react90.default.createElement(menu_default.SubMenu, { key: L.key, icon: O ?? import_react90.default.createElement(UnorderedListOutlined_default, null), title: M }, T(w, q)));
    let se2 = N === q, _ = !(A(J == null ? void 0 : J.parent, X == null ? void 0 : X.parent, R) !== void 0 && w.length === 0);
    return import_react90.default.createElement(wc, { key: L.key, resource: z, action: "list", params: { resource: L } }, import_react90.default.createElement(menu_default.Item, { key: L.key, style: { fontWeight: se2 ? "bold" : "normal" }, icon: O ?? (_ && import_react90.default.createElement(UnorderedListOutlined_default, null)) }, import_react90.default.createElement(f, { to: Y2 ?? "" }, M), !s && se2 && import_react90.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), v = o2(() => {
...
var Lt = o2(({ Title: e2, render: t, meta: r }) => {
  let { token: s } = theme_default.useToken(), [n2, i] = (0, import_react94.useState)(false), [a, p] = (0, import_react94.useState)(false), l = yo(), m = se(), u = yt(), { warnWhen: d, setWarnWhen: c } = vt(), { Link: f } = le(), h = m === "legacy" ? f : u, y = Ta(), g = $(), { menuItems: b, selectedKey: P, defaultOpenKeys: B } = $u({ meta: r }), C = grid_default.useBreakpoint(), { hasDashboard: S } = ge(), k = ie(), { mutate: F } = Mr({ v3LegacyAuthProviderCompatible: !!(k != null && k.isLegacy) }), D = typeof C.lg > "u" ? false : !C.lg, T = e2 ?? y ?? kt, v = o2((E, q) => E.map((L) => {
    let { icon: O, label: M, route: Y2, key: N, name: z, children: w, parentName: R, meta: J, options: X } = L;
    if (w.length > 0) return import_react94.default.createElement(wc, { key: L.key, resource: z, action: "list", params: { resource: L } }, import_react94.default.createElement(menu_default.SubMenu, { key: L.key, icon: O ?? import_react94.default.createElement(UnorderedListOutlined_default, null), title: M }, v(w, q)));
    let se2 = N === q, _ = !(A(J == null ? void 0 : J.parent, X == null ? void 0 : X.parent, R) !== void 0 && w.length === 0);
    return import_react94.default.createElement(wc, { key: L.key, resource: z, action: "list", params: { resource: L } }, import_react94.default.createElement(menu_default.Item, { key: L.key, icon: O ?? (_ && import_react94.default.createElement(UnorderedListOutlined_default, null)) }, import_react94.default.createElement(h, { to: Y2 ?? "" }, M), !n2 && se2 && import_react94.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), U = o2(() => {
    d ? window.confirm(g("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (c(false), F()) : F();
  }, "handleLogout"), H = l && import_react94.default.createElement(menu_default.Item, { key: "logout", onClick: () => U(), icon: import_react94.default.createElement(LogoutOutlined_default, null) }, g("buttons.logout", "Logout")), j = S ? import_react94.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react94.default.createElement(DashboardOutlined_default, null) }, import_react94.default.createElement(h, { to: "/" }, g("dashboard.title", "Dashboard")), !n2 && P === "/" && import_react94.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, x = v(b, P), K = o2(() => t ? t({ dashboard: j, items: x, logout: H, collapsed: n2 }) : import_react94.default.createElement(import_react94.default.Fragment, null, j, x, H), "renderSider"), $2 = o2(() => import_react94.default.createElement(import_react94.default.Fragment, null, import_react94.default.createElement(menu_default, { selectedKeys: P ? [P] : [], defaultOpenKeys: B, mode: "inline", style: { marginTop: "8px", border: "none" }, onClick: () => {
    p(false), C.lg || i(true);
  } }, K())), "renderMenu"), A2 = o2(() => import_react94.default.createElement(import_react94.default.Fragment, null, import_react94.default.createElement(drawer_default, { open: a, onClose: () => p(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react94.default.createElement(layout_default, null, import_react94.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden", backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` } }, import_react94.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated } }, import_react94.default.createElement(T, { collapsed: false })), $2()))), import_react94.default.createElement(button_default, { style: ho, size: "large", onClick: () => p(true), icon: import_react94.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return D ? A2() : import_react94.default.createElement(layout_default.Sider, { style: { backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` }, collapsible: true, collapsed: n2, onCollapse: (E) => i(E), collapsedWidth: 80, breakpoint: "lg", trigger: import_react94.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: s.colorBgElevated } }, n2 ? import_react94.default.createElement(RightOutlined_default, { style: { color: s.colorPrimary } }) : import_react94.default.createElement(LeftOutlined_default, { style: { color: s.colorPrimary } })) }, import_react94.default.createElement("div", { style: { width: n2 ? "80px" : "200px", padding: n2 ? "0" : "0 16px", display: "flex", justifyContent: n2 ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated, fontSize: "14px" } }, import_react94.default.createElement(T, { collapsed: n2 })), $2());
}, "ThemedSider");
var Dt = o2(() => {
...
var Rt = o2(({ Title: e2, render: t, meta: r, fixed: s, activeItemDisabled: n2 = false }) => {
  var Y2;
  let { token: i } = theme_default.useToken(), { siderCollapsed: a, setSiderCollapsed: p, mobileSiderOpen: l, setMobileSiderOpen: m } = fo2(), u = yo(), d = (Y2 = (0, import_react98.useContext)(config_provider_default.ConfigContext)) == null ? void 0 : Y2.direction, c = se(), f = yt(), { warnWhen: h, setWarnWhen: y } = vt(), { Link: g } = le(), b = c === "legacy" ? g : f, P = Ta(), B = $(), { menuItems: C, selectedKey: S, defaultOpenKeys: k } = $u({ meta: r }), F = grid_default.useBreakpoint(), { hasDashboard: D } = ge(), T = ie(), { mutate: v } = Mr({ v3LegacyAuthProviderCompatible: !!(T != null && T.isLegacy) }), U = typeof F.lg > "u" ? false : !F.lg, H = e2 ?? P ?? be, j = o2((N, z) => N.map((w) => {
    let { icon: R, label: J, route: X, key: se2, name: _, children: fe, parentName: Z, meta: ee, options: le2 } = w;
    if (fe.length > 0) return import_react98.default.createElement(wc, { key: w.key, resource: _, action: "list", params: { resource: w } }, import_react98.default.createElement(menu_default.SubMenu, { key: w.key, icon: R ?? import_react98.default.createElement(UnorderedListOutlined_default, null), title: J }, j(fe, z)));
    let ie2 = se2 === z, de = !(A(ee == null ? void 0 : ee.parent, le2 == null ? void 0 : le2.parent, Z) !== void 0 && fe.length === 0), te = n2 && ie2 ? { pointerEvents: "none" } : {};
    return import_react98.default.createElement(wc, { key: w.key, resource: _, action: "list", params: { resource: w } }, import_react98.default.createElement(menu_default.Item, { key: w.key, icon: R ?? (de && import_react98.default.createElement(UnorderedListOutlined_default, null)), style: te }, import_react98.default.createElement(b, { to: X ?? "", style: te }, J), !a && ie2 && import_react98.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), x = o2(() => {
    h ? window.confirm(B("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (y(false), v()) : v();
  }, "handleLogout"), K = u && import_react98.default.createElement(menu_default.Item, { key: "logout", onClick: () => x(), icon: import_react98.default.createElement(LogoutOutlined_default, null) }, B("buttons.logout", "Logout")), $2 = D ? import_react98.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react98.default.createElement(DashboardOutlined_default, null) }, import_react98.default.createElement(b, { to: "/" }, B("dashboard.title", "Dashboard")), !a && S === "/" && import_react98.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, A2 = j(C, S), E = o2(() => t ? t({ dashboard: $2, items: A2, logout: K, collapsed: a }) : import_react98.default.createElement(import_react98.default.Fragment, null, $2, A2, K), "renderSider"), q = o2(() => import_react98.default.createElement(menu_default, { selectedKeys: S ? [S] : [], defaultOpenKeys: k, mode: "inline", style: { paddingTop: "8px", border: "none", overflow: "auto", height: "calc(100% - 72px)" }, onClick: () => {
    m(false);
  } }, E()), "renderMenu"), L = o2(() => import_react98.default.createElement(import_react98.default.Fragment, null, import_react98.default.createElement(drawer_default, { open: l, onClose: () => m(false), placement: d === "rtl" ? "right" : "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react98.default.createElement(layout_default, null, import_react98.default.createElement(layout_default.Sider, { style: { height: "100vh", backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` } }, import_react98.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated } }, import_react98.default.createElement(H, { collapsed: false })), q()))), import_react98.default.createElement(button_default, { style: vo, size: "large", onClick: () => m(true), icon: import_react98.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  if (U) return L();
...
var be = o2(({ collapsed: e2, icon: t, text: r, wrapperStyles: s }) => {
  let { title: { icon: n2, text: i } = {} } = At(), a = typeof t > "u" ? n2 : t, p = typeof r > "u" ? i : r, { token: l } = theme_default.useToken(), m = se(), u = yt(), { Link: d } = le();
...
var Ht = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...p }) => {
  let { hidden: l, disabled: m, label: u, title: d, LinkComponent: c, to: f } = Yv({ resource: e2 ?? t, meta: n2, accessControl: s }), h = m || p.disabled;
...
var Ot = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: p, ...l }) => {
  let { to: m, label: u, title: d, hidden: c, disabled: f, LinkComponent: h } = Xv({ resource: e2 ?? t, id: r, meta: i, accessControl: n2 }), y = f || l.disabled;
...
var Ye = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, onSuccess: s, mutationMode: n2, children: i, successNotification: a, errorNotification: p, hideText: l = false, accessControl: m, metaData: u, meta: d, dataProviderName: c, confirmTitle: f, confirmOkText: h, confirmCancelText: y, invalidates: g, ...b }) => {
  let { title: P, label: B, hidden: C, disabled: S, loading: k, confirmTitle: F, confirmOkLabel: D, cancelLabel: T, onConfirm: v } = Yu({ resource: e2 ?? t, id: r, dataProviderName: c, invalidates: g, meta: d, onSuccess: s, mutationMode: n2, errorNotification: p, successNotification: a, accessControl: m }), U = S || b.disabled;
...
var _e2 = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, dataProviderName: n2, children: i, meta: a, metaData: p, ...l }) => {
  let { onClick: m, label: u, loading: d } = Ju({ resource: e2 ?? t, id: r, dataProviderName: n2 });
...
var Aa = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: p, ...l }) => {
  let { to: m, label: u, title: d, hidden: c, disabled: f, LinkComponent: h } = jv({ resource: e2 ?? t, id: r, accessControl: n2, meta: i }), y = f || l.disabled;
...
var Ze = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...p }) => {
  let { to: l, label: m, title: u, hidden: d, disabled: c, LinkComponent: f } = qv({ resource: e2 ?? t, meta: n2, accessControl: s }), h = c || p.disabled;
...
var ni = o2(({ resourceNameOrRouteName: e2, resource: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: p, ...l }) => {
  let { to: m, LinkComponent: u, label: d, disabled: c, hidden: f, title: h } = Zv({ id: r, resource: t ?? e2, accessControl: n2, meta: i }), y = c || l.disabled;
...
var xi = o2(({ canCreate: e2, title: t, children: r, createButtonProps: s, resource: n2, wrapperProps: i, contentProps: a, headerProps: p, breadcrumb: l, headerButtonProps: m, headerButtons: u }) => {
  var S, k;
  let d = $(), { options: { breadcrumb: c } = {} } = ge(), f = se(), h = Pt(), { resource: y, identifier: g } = Y(n2), b = e2 ?? (((y == null ? void 0 : y.canCreate) ?? !!(y != null && y.create)) || s), P = typeof l > "u" ? c : l, B = b ? { size: "middle", resource: f === "legacy" ? y == null ? void 0 : y.route : g, ...s } : void 0, C = b ? import_react111.default.createElement(Ht, { ...B }) : null;
...
var Di = o2(({ title: e2, saveButtonProps: t, children: r, resource: s, isLoading: n2 = false, breadcrumb: i, wrapperProps: a, headerProps: p, contentProps: l, headerButtonProps: m, headerButtons: u, footerButtonProps: d, footerButtons: c, goBack: f }) => {
  var v, U;
  let h = $(), { options: { breadcrumb: y } = {} } = ge(), g = se(), b = Mo(), { goBack: P } = Pe(), B = Pt(), { resource: C, action: S, identifier: k } = Y(s), F = typeof i > "u" ? y : i, D = { ...n2 ? { disabled: true } : {}, ...t, htmlType: "submit" }, T = import_react112.default.createElement(import_react112.default.Fragment, null, import_react112.default.createElement(Xe, { ...D }));
...
var zi = o2(({ title: e2, saveButtonProps: t, mutationMode: r, recordItemId: s, children: n2, deleteButtonProps: i, canDelete: a, resource: p, isLoading: l = false, dataProviderName: m, breadcrumb: u, wrapperProps: d, headerProps: c, contentProps: f, headerButtonProps: h, headerButtons: y, footerButtonProps: g, footerButtons: b, goBack: P, autoSaveProps: B }) => {
  var X, se2, _;
  let C = $(), { options: { breadcrumb: S } = {} } = ge(), { mutationMode: k } = _e(), F = r ?? k, D = se(), T = Mo(), v = he(), { goBack: U, list: H } = Pe(), j = Pt(), { resource: x, action: K, id: $2, identifier: A2 } = Y(p), E = bu({ resource: x, action: "list" }), q = s ?? $2, L = typeof u > "u" ? S : u, O = (x == null ? void 0 : x.list) && !s, M = a ?? ((((X = x == null ? void 0 : x.meta) == null ? void 0 : X.canDelete) ?? (x == null ? void 0 : x.canDelete)) || i), Y2 = O ? { ...l ? { disabled: true } : {}, resource: D === "legacy" ? x == null ? void 0 : x.route : A2 } : void 0, N = { ...l ? { disabled: true } : {}, resource: D === "legacy" ? x == null ? void 0 : x.route : A2, recordItemId: q, dataProviderName: m }, z = M ? { ...l ? { disabled: true } : {}, resource: D === "legacy" ? x == null ? void 0 : x.route : A2, mutationMode: F, onSuccess: () => {
    D === "legacy" ? H((x == null ? void 0 : x.route) ?? (x == null ? void 0 : x.name) ?? "") : v({ to: E });
  }, recordItemId: q, dataProviderName: m, ...i } : void 0, w = { ...l ? { disabled: true } : {}, ...t }, R = import_react113.default.createElement(import_react113.default.Fragment, null, B && import_react113.default.createElement(Oo, { ...B }), O && import_react113.default.createElement(Ze, { ...Y2 }), import_react113.default.createElement(_e2, { ...N })), J = import_react113.default.createElement(import_react113.default.Fragment, null, M && import_react113.default.createElement(Ye, { ...z }), import_react113.default.createElement(Xe, { ...w }));
  return import_react113.default.createElement("div", { ...d ?? {} }, import_react113.default.createElement(ke, { backIcon: P, onBack: K !== "list" && typeof K < "u" ? D === "legacy" ? U : T : void 0, title: e2 ?? C(`${A2}.titles.edit`, `Edit ${j(((se2 = x == null ? void 0 : x.meta) == null ? void 0 : se2.label) ?? ((_ = x == null ? void 0 : x.options) == null ? void 0 : _.label) ?? (x == null ? void 0 : x.label) ?? A2, "singular")}`), extra: import_react113.default.createElement(space_default, { wrap: true, ...h ?? {} }, y ? typeof y == "function" ? y({ defaultButtons: R, listButtonProps: Y2, refreshButtonProps: N }) : y : R), breadcrumb: typeof L < "u" ? import_react113.default.createElement(import_react113.default.Fragment, null, L) ?? void 0 : import_react113.default.createElement(Le, null), ...c ?? {} }, import_react113.default.createElement(spin_default, { spinning: l }, import_react113.default.createElement(card_default, { bordered: false, actions: [import_react113.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...g ?? {} }, b ? typeof b == "function" ? b({ defaultButtons: J, deleteButtonProps: z, saveButtonProps: w }) : b : J)], ...f ?? {} }, n2))));
}, "Edit");
var ep = o2(({ title: e2, canEdit: t, canDelete: r, isLoading: s = false, children: n2, resource: i, recordItemId: a, dataProviderName: p, breadcrumb: l, contentProps: m, headerProps: u, wrapperProps: d, headerButtons: c, footerButtons: f, footerButtonProps: h, headerButtonProps: y, goBack: g }) => {
  var N, z, w;
  let b = $(), { options: { breadcrumb: P } = {} } = ge(), B = se(), C = Mo(), S = he(), { goBack: k, list: F } = Pe(), D = Pt(), { resource: T, action: v, id: U, identifier: H } = Y(i), j = bu({ resource: T, action: "list" }), x = a ?? U, K = typeof l > "u" ? P : l, $2 = (T == null ? void 0 : T.list) && !a, A2 = r ?? ((N = T == null ? void 0 : T.meta) == null ? void 0 : N.canDelete) ?? (T == null ? void 0 : T.canDelete), E = t ?? (T == null ? void 0 : T.canEdit) ?? !!(T != null && T.edit), q = $2 ? { resource: B === "legacy" ? T == null ? void 0 : T.route : H } : void 0, L = E ? { ...s ? { disabled: true } : {}, type: "primary", resource: B === "legacy" ? T == null ? void 0 : T.route : H, recordItemId: x } : void 0, O = A2 ? { ...s ? { disabled: true } : {}, resource: B === "legacy" ? T == null ? void 0 : T.route : H, recordItemId: x, onSuccess: () => {
    B === "legacy" ? F((T == null ? void 0 : T.route) ?? (T == null ? void 0 : T.name) ?? "") : S({ to: j });
  }, dataProviderName: p } : void 0, M = { ...s ? { disabled: true } : {}, resource: B === "legacy" ? T == null ? void 0 : T.route : H, recordItemId: x, dataProviderName: p }, Y2 = import_react114.default.createElement(import_react114.default.Fragment, null, $2 && import_react114.default.createElement(Ze, { ...q }), E && import_react114.default.createElement(Ot, { ...L }), A2 && import_react114.default.createElement(Ye, { ...O }), import_react114.default.createElement(_e2, { ...M }));
  return import_react114.default.createElement("div", { ...d ?? {} }, import_react114.default.createElement(ke, { backIcon: g, onBack: v !== "list" && typeof v < "u" ? B === "legacy" ? k : C : void 0, title: e2 ?? b(`${H}.titles.show`, `Show ${D(((z = T == null ? void 0 : T.meta) == null ? void 0 : z.label) ?? ((w = T == null ? void 0 : T.options) == null ? void 0 : w.label) ?? (T == null ? void 0 : T.label) ?? H, "singular")}`), extra: import_react114.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...y ?? {} }, c ? typeof c == "function" ? c({ defaultButtons: Y2, deleteButtonProps: O, editButtonProps: L, listButtonProps: q, refreshButtonProps: M }) : c : Y2), breadcrumb: typeof K < "u" ? import_react114.default.createElement(import_react114.default.Fragment, null, K) ?? void 0 : import_react114.default.createElement(Le, null), ...u ?? {} }, import_react114.default.createElement(spin_default, { spinning: s }, import_react114.default.createElement(card_default, { bordered: false, actions: f ? [import_react114.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...h }, typeof f == "function" ? f({ defaultButtons: null }) : f)] : void 0, ...m ?? {} }, n2))));
}, "Show");
...
var Hp = o2((e2) => {
  let { setSelectedKeys: t, confirm: r, clearFilters: s, mapValue: n2 = o2((c) => c, "mapValue"), selectedKeys: i, children: a } = e2, p = $(), l = o2(() => {
    s && s();
  }, "clearFilter"), m = o2(() => {
    let c;
...
var Yp = o2(() => {
  let [e2, t] = (0, import_react126.useState)(), r = $(), { push: s } = Pe(), n2 = he(), i = se(), { resource: a, action: p } = Y();
...
var nl = o2(() => {
  let [e2] = form_default.useForm(), t = $(), r = ie(), { mutate: s, isLoading: n2 } = $t({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) }), i = import_react127.default.createElement(typography_default.Title, { level: 3, style: qo }, t("pages.login.title", "Sign in your account"));
...
var Tl = o2(() => import_react128.default.createElement(dc, null), "WelcomePage");
var De = {};
...
var Le = o2(({ breadcrumbProps: e2, showHome: t = true, hideIcons: r = false, meta: s, minItems: n2 = 2 }) => {
  let i = se(), { breadcrumbs: a } = lb({ meta: s }), p = yt(), { Link: l } = le(), { hasDashboard: m } = ge(), { resources: u } = Y(), d = as("/", u), c = i === "legacy" ? l : p;
