...
var G = ({ children: e }) => {
  let { resources: t } = Y(), n = import_react3.default.useMemo(() => T(t), [t]);
  return e ? e(n) : import_react3.default.createElement(Routes, null, n);
};
var O = ({ resource: e, meta: t }) => {
  let n = Ut(), { resource: i, resources: s } = Y(e), r = i || s.find((o) => o.list);
  if (r) {
...
var _ = ({ translationKey: e = "warnWhenUnsavedChanges", message: t = "Are you sure you want to leave? You have unsaved changes." }) => {
  let n = $(), { pathname: i } = useLocation(), { warnWhen: s, setWarnWhen: r } = vt();
...
function ce({ handler: e }) {
  var d;
  let t = useLocation(), { action: n, id: i, params: s, pathname: r, resource: o } = Te(), a = $(), c = Pt(), f = (o == null ? void 0 : o.identifier) ?? (o == null ? void 0 : o.name), p = (o == null ? void 0 : o.label) ?? ((d = o == null ? void 0 : o.meta) == null ? void 0 : d.label) ?? c(f, n === "list" ? "plural" : "singular"), m = a(`${o == null ? void 0 : o.name}.${o == null ? void 0 : o.name}`, p);
